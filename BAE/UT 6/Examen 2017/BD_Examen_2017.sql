CREATE DATABASE  IF NOT EXISTS `almacensl_2017` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_general_ci */;
USE `almacensl_2017`;
...
--
-- Table structure for table `proacducto`
--
...
-- Dump completed on 2017-06-13  1:25:00
